...
const Navbar = () => {
    ...
    const navItems = (
        <>
            <li className="rounded-md dark:hover:bg-pink-500 duration-200"><Link to="/">Trang chủ</Link></li>
            <li className="rounded-md dark:hover:bg-pink-500 duration-200"><Link to="/profile">Hồ sơ</Link></li>
            {isAdmin && (
